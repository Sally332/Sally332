# 👩‍🔬 Computational Biologist | Statistical Genomics, Multiomic Integration, Single-Cell & Spatial Biology

Computational biologist with expertise in statistical genomics, multiomic integration, single-cell and spatial transcriptomics, and biologically informed machine learning. My work focuses on developing computational methods and reproducible analytical frameworks that connect molecular data, biological knowledge, and quantitative modeling to investigate cellular organization, regulatory mechanisms, and disease processes.

## 🔬 Research Focus

My research lies at the intersection of computational biology, statistical genomics, and systems biology. I develop and evaluate computational approaches for integrating high-dimensional molecular data, characterizing cellular heterogeneity, modeling biological interactions, and extracting biologically meaningful insight from complex genomic and spatial datasets.

I am particularly interested in computational method development, multimodal data integration, cell–cell communication, biological representation learning, and rigorous evaluation frameworks that improve the interpretability, reproducibility, and biological relevance of modern analytical approaches.

## 📂 Key Projects

### [Single-Cell Concept Interpretability](https://github.com/Sally332/single-cell-concept-interpretability)
...
### [Falsification-Based Evaluation of Spatial Pathway Models](https://github.com/Sally332/Falsification-based-evaluation-spatial-pathway-models)
...
### [Organoid Analysis Framework](https://github.com/Sally332/Organoid_Analysis)
...
### [Spatial Transcriptomic Mapping](https://github.com/Sally332/Spatial_Transcriptomic_Mapping)
...
### [PacBio Structural Variant Pipeline](https://github.com/Sally332/PacBio-SV-Pipeline)
...
### [Burden Testing Pipeline](https://github.com/Sally332/Burden-Testing)
